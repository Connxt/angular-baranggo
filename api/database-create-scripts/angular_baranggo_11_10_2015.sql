...
-- Dumping data for table baranggo_api.barangays: ~2 rows (approximately)
...
INSERT INTO `barangay_business_clearances` (`id`, `person_id`, `business_name`, `business_address`, `business_type`, `date_issued`, `created_at`) VALUES
	(1, 88, 'asd', 'asd', 'asd', '2015-11-10 20:03:00', '2015-11-10 20:03:00');
...
-- Dumping data for table baranggo_api.barangay_clearances: ~1 rows (approximately)
/*!40000 ALTER TABLE `barangay_clearances` DISABLE KEYS */;
INSERT INTO `barangay_clearances` (`id`, `person_id`, `reason`, `remarks`, `date_issued`, `created_at`) VALUES
	(1, 88, 'asd', 'asd', '2015-10-30 21:34:15', '2015-10-30 21:34:15');
...
INSERT INTO `certificates_of_closure` (`id`, `person_id`, `business_name`, `business_address`, `business_type`, `date_closed`, `date_issued`, `created_at`) VALUES
	(1, 86, '1', '1', '1', '2015-11-10', '2015-11-10 20:03:45', '2015-11-10 20:03:46');
...
-- Dumping data for table baranggo_api.children: ~14 rows (approximately)
...
-- Dumping data for table baranggo_api.cities: ~2 rows (approximately)
/*!40000 ALTER TABLE `cities` DISABLE KEYS */;
INSERT INTO `cities` (`id`, `city`, `zip_code`, `province_id`, `code`) VALUES
	(1, 'Kabankalan City', '6111', 1, NULL),
	(2, 'Himamaylan', '6112', 1, NULL);
...
-- Dumping data for table baranggo_api.persons: ~15 rows (approximately)
...
INSERT INTO `persons` (`id`, `last_name`, `first_name`, `middle_name`, `date_of_birth`, `place_of_birth`, `gender`, `mother_last_name`, `mother_first_name`, `mother_middle_name`, `mother_date_of_birth`, `father_last_name`, `father_first_name`, `father_middle_name`, `father_date_of_birth`, `contact_no`, `email`, `created_at`, `updated_at`) VALUES
	(75, 'Felipe', 'Jan Ryan', 'Malicay', '1992-12-07', 'Paranaque', 'Male', 'Malicay', 'Charlie', 'Sumalpong', '1961-09-13 00:00:00', 'Felipe', 'Benjamin', 'Javier', '1951-07-27 00:00:00', 'sample contact no.', 'sample email address', '2015-10-22 09:58:47', '2015-11-09 11:31:09'),
...
INSERT INTO `residences` (`id`, `block_no`, `lot_no`, `street`, `sitio`, `subdivision`, `latitude`, `longitude`, `barangay_id`, `code`, `created_at`) VALUES
	(00000000001, 7, 7, 'Rose', '1', 'FZO', 100, 200, 1, NULL, '2015-10-29 19:59:50');
/*!40000 ALTER TABLE `residences` ENABLE KEYS */;


-- Dumping structure for table baranggo_api.settings
CREATE TABLE IF NOT EXISTS `settings` (
  `barangay_id` int(11) DEFAULT NULL,
  KEY `settings_barangay_id_to_barangays_id` (`barangay_id`),
  CONSTRAINT `settings_barangay_id_to_barangays_id` FOREIGN KEY (`barangay_id`) REFERENCES `barangays` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table baranggo_api.settings: ~1 rows (approximately)
/*!40000 ALTER TABLE `settings` DISABLE KEYS */;
INSERT INTO `settings` (`barangay_id`) VALUES
	(2);
...
-- Dumping data for table baranggo_api.temp_person_infos: ~19 rows (approximately)
...
INSERT INTO `temp_person_infos` (`id`, `civil_status`, `religion`, `annual_income`, `educational_attainment`, `is_employed`, `is_voter`, `is_deceased`, `with_philhealth`, `with_sss`, `with_electricity`, `with_water`, `person_id`, `residence_id`, `spouse_last_name`, `spouse_first_name`, `spouse_middle_name`, `spouse_date_of_birth`, `spouse_gender`, `created_at`) VALUES
	...
	(111, 'Single', 'Catholic', 100000, 'College', 1, 1, 0, 1, 1, 1, 1, 75, 00000000001, 'Salcedo', 'Kristine Jeed', 'Arroz', '1993-04-07', 'Female', '2015-11-09 11:28:33'),
	(112, 'Single', 'Catholic', 100000, 'College', 1, 1, 0, 1, 1, 1, 1, 75, 00000000001, 'Salcedo', 'Kristine Jeed', 'Arroz', '1993-04-07', 'Female', '2015-11-09 11:29:20'),
	(113, 'Single', 'Catholic', 100000, 'College', 1, 1, 0, 1, 1, 1, 1, 75, 00000000001, 'Salcedo', 'Kristine Jeed', 'Arroz', '1993-04-07', 'Female', '2015-11-09 11:30:50'),
	(114, 'Single', 'Catholic', 100000, 'College', 1, 1, 0, 1, 1, 1, 1, 75, 00000000001, 'Salcedo', 'Kristine Jeed', 'Arroz', '1993-04-07', 'Female', '2015-11-09 11:31:10');
