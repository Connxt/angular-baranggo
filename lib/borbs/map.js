var map = function() {
	...
	outdoor.eachLayer( function (locale) {
		...
		var lat = coor[1];
		var lng = coor[0];
		var content = '<h3>' + family + '<br/></h3><div class="popup-content"><p>' + street + ' Brgy. ' + brgy + ' ' + city + '<br/> <strong>Members</strong>:'  + memar + '</p></div>';
	...
	L.control
		.layers(layers, null, { position: "topleft" })
		.addTo(map)
		.addOverlay(residencialHouses, " Houses");
