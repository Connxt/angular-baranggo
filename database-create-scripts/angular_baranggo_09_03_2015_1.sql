...
CREATE TABLE IF NOT EXISTS `personal_info` (
  ...
  KEY `temporary_persons_info_residence_id_to_residences_id` (`residence_id`),
  KEY `temporary_persons_info_spouse_id_to_persons_id` (`spouse_id`),
  CONSTRAINT `temporary_persons_info_person_id_to_persons_id` FOREIGN KEY (`person_id`) REFERENCES `persons` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `temporary_persons_info_residence_id_to_residences_id` FOREIGN KEY (`residence_id`) REFERENCES `residences` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `temporary_persons_info_spouse_id_to_persons_id` FOREIGN KEY (`spouse_id`) REFERENCES `persons` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `personal_info` (`id`, `last_name`, `first_name`, `middle_name`, `civil_status`, `religion`, `occupation`, `annual_income`, `educational_attainment`, `is_voter`, `person_id`, `residence_id`, `spouse_id`, `created_at`) VALUES
	(1, 'Felipe', 'Jan Ryan', 'Malicay', 'Single', 'Catholic', 'Software Developer', '1000000', 'College', 1, 1, 1, NULL, '2015-09-03 18:47:08'),
	(2, 'Felipe', 'Benjamin', 'Javier', 'Married', 'Catholic', 'Municipal Officer', '999999', 'College', 1, 2, 1, 3, '2015-09-03 18:47:12'),
	(3, 'Malicay', 'Charlie', 'Sumalpong', 'Married', 'Catholic', 'Manager', '999999', 'College', 1, 3, 1, 2, '2015-09-03 18:47:13'),
	(4, 'Felipe', 'Jan Richard', 'Malicay', 'Single', 'Catholic', 'Ewan', '999999', 'College', 1, 4, 1, NULL, '2015-09-03 18:47:14'),
	(5, 'Felipe', 'Janelle Rose', 'Malicay', 'Single', 'Catholic', 'Ewan', '999999', 'College', 1, 5, 1, NULL, '2015-09-03 18:47:15'),
	(6, 'Felipe', 'Jan Ryan', 'Malicay', 'Married', 'Catholic', 'Software Yeah', '1000000', 'Masters', 1, 1, 1, NULL, '2015-09-03 18:49:16');
...
INSERT INTO `residences` (`id`, `no`, `street`, `lat`, `long`, `barangay_id`) VALUES
	(1, 7, 'Rose', 100, 200, 1);
...
-- Dumping data for table baranggo_app.users: ~0 rows (approximately)
